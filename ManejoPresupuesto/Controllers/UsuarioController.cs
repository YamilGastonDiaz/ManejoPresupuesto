...
namespace ManejoPresupuesto.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        {
            var mensaje = "Proceso concluido. Si el email dado se corresponde con uno de nuestros usuarios, " +
            ...
            var enlace = Url.Action("RecuperarPassword", "Usuario", new { codigo = codigoBase64 },
        ...
        public async Task<IActionResult> RecuperarPassword(RecuperarPasswordViewModel modelo)
        {
            ...
            var resultados = await _userManager.ResetPasswordAsync(usuario, modelo.CodigoReseteo,
                modelo.Password);
