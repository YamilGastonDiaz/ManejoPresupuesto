...
namespace ManejoPresupuesto.Service
{
        ...
        IUserPasswordStore<Usuario>
    {
        ...
        {
            user.Id = await _usuarioRepository.CrearUsuario(user);
        ...
        {
            return await _usuarioRepository.BuscarUsuarioPorEmail(normalizedEmail);
        }
        ...
        {
            return await _usuarioRepository.BuscarUsuarioPorEmail(normalizedUserName);
        }
        ...
        {
            await _usuarioRepository.Actualizar(user);
            return IdentityResult.Success;
        }
    }
}
