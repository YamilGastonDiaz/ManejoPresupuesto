...
{
    public class ReportesTransaccionesDetallada
    {
        ...
        public class TransaccionesPorFecha
        {
            ...
            public decimal BalanceDepositos =>
                Transacciones.Where(x => x.IdTipoTransaccion == TipoTransaccion.Ingreso)
                .Sum(x => x.Monto);
            public decimal BalanceRetiros =>
                Transacciones.Where(x => x.IdTipoTransaccion == TipoTransaccion.Gasto)
                .Sum(x => x.Monto);
        }
    }
}
